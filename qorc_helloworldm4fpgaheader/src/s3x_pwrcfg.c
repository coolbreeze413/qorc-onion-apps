...
// COST_FREQ == 1  HSOSC_DEF_RATE to set HSOSC. HSOSC_DEF_RATE can be found in s3x_pwrcfg.h
...
/* This value is determined from the icf and ld file.
    ROM and RAM2 blocks cab be put into light sleep*/
...
{
    if(0 == state)      /* Disable sram blocks going into lpm*/
    {
        sram_lpm_blocks = 0x0;
    }
