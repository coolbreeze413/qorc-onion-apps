...
const char *SOFTWARE_VERSION_STR="QF_BL 3.0" ;

// The entry Function of the BL when the system boots up.
int main(void)
{
#if defined(__ICCARM__)
    SOFTWARE_VERSION_STR = "qorc-sdk/qf-apps/qf_bl_cli(v3.0) (IAR)";
#elif defined(__GNUC__)
    SOFTWARE_VERSION_STR = "qorc-sdk/qf-apps/qf_bl_cli(v3.0) (GCC)";
#endif
