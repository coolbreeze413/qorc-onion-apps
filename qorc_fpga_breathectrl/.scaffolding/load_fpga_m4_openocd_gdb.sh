...
# fpga-m4 load:
# load both fpga and m4 'images' -> m4 binary generated from gcc, fpga openocd script generated from symbiflow tools
...
CUSTOM_OPENOCD_GDB_LOG="fpga_m4_load_custom_openocd_gdb.log"
