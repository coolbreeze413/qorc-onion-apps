...
export INCLUDE_DIRS=-I"$(PROJ_DIR)" \
                 -I"$(APP_DIR)/inc" \
                 -I"$(APP_DIR)/drivers/bma400/inc" \
                 -I"$(APP_DIR)/drivers/bmx160/inc" \
                 -I"$(APP_DIR)/drivers/dps310/inc" \
                 -I"$(APP_DIR)/drivers/hx3313/inc" \
                 -I"$(APP_DIR)/tasks/inc" \
...
export MAIN_DRIVERS_HX3313             = $(APP_DIR)$(DIR_SEP)drivers$(DIR_SEP)hx3313$(DIR_SEP)src
export MAIN_TASKS                      = $(APP_DIR)$(DIR_SEP)tasks$(DIR_SEP)src
